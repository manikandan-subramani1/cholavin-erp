...
> Architecture: **Company → Godown → Shop**  
> Stack: Laravel 12, PHP 8.2+, MySQL, Blade, Bootstrap 5, jQuery, AJAX, Yajra DataTables  
> Use this document together with the module reference image.
...
2. Fixed top header
3. Godown, shop and financial-year selectors
4. Breadcrumb, title and description
5. KPI cards
6. Search and smart filters
7. Main DataTable or transaction workspace
8. Module quick actions
9. Right-side AJAX drawer
10. Lazy-loaded tabs
11. Activity timeline
12. Responsive mobile cards
...
1. Files analyzed
2. Existing routes and endpoints
3. Models and database tables used
4. Existing permissions
5. Existing business logic preserved
6. Current UI and performance issues
7. Files changed and created
8. Validation rules
9. AJAX response handling
