...
use App\Http\Requests\TaxRates\TaxRateRequest;
...
{
    private const TYPE = 'tax_rate';

    private const SLUG = 'tax-rates';

    private const TITLE = 'Tax Rate';
    ...
    public function update(TaxRateRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
