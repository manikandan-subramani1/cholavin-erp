...
{
    private const TYPE = 'price_list';

    private const SLUG = 'price-lists';

    private const TITLE = 'Price List';
    ...
    public function update(PriceListRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
