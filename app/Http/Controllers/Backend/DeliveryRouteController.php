...
use App\Http\Requests\DeliveryRoutes\DeliveryRouteRequest;
...
{
    private const TYPE = 'delivery_route';

    private const SLUG = 'delivery-routes';

    private const TITLE = 'Delivery Route';
    ...
    public function update(DeliveryRouteRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
