...
use App\Http\Requests\NumberSequences\NumberSequenceRequest;
...
{
    private const TYPE = 'number_sequence';

    private const SLUG = 'number-sequences';

    private const TITLE = 'Number Sequence';
    ...
    public function store(NumberSequenceRequest $request): JsonResponse
    {
    ...
    public function update(NumberSequenceRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
