...
{
    private const TYPE = 'customer_group';

    private const SLUG = 'customer-groups';

    private const TITLE = 'Customer Group';
    ...
    private const TABLE_COLUMNS = [
        'name' => 'Group Name',
        'code' => 'Code',
        'credit_days' => 'Default Credit Days',
    ...
    public function update(CustomerGroupRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
