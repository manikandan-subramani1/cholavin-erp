...
use App\Http\Requests\FinancialYears\FinancialYearRequest;
...
{
    private const TYPE = 'financial_year';

    private const SLUG = 'financial-years';

    private const TITLE = 'Financial Year';
    ...
    public function update(FinancialYearRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
