...
use App\Http\Requests\TaxConfigurations\TaxConfigurationRequest;
...
{
    private const TYPE = 'tax_configuration';

    private const SLUG = 'tax-configurations';

    private const TITLE = 'Tax Configuration';
    ...
    public function store(TaxConfigurationRequest $request): JsonResponse
    {
    ...
    public function update(TaxConfigurationRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
