...
use App\Http\Requests\HsnSacCodes\HsnSacCodeRequest;
...
{
    private const TYPE = 'hsn_sac';

    private const SLUG = 'hsn-sac-codes';

    private const TITLE = 'HSN / SAC Code';
    ...
    public function store(HsnSacCodeRequest $request): JsonResponse
    {
    ...
    public function update(HsnSacCodeRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
