...
use App\Http\Requests\SupplierGroups\SupplierGroupRequest;
...
{
    private const TYPE = 'supplier_group';

    private const SLUG = 'supplier-groups';

    private const TITLE = 'Supplier Group';
    ...
    private const TABLE_COLUMNS = [
        'name' => 'Group Name',
        'code' => 'Code',
        'payment_days' => 'Default Payment Days',
    ...
    public function update(SupplierGroupRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
