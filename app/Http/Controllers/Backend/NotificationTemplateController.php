...
use App\Http\Requests\NotificationTemplates\NotificationTemplateRequest;
...
{
    private const TYPE = 'notification_template';

    private const SLUG = 'notification-templates';

    private const TITLE = 'Notification Template';
    ...
    public function update(NotificationTemplateRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
