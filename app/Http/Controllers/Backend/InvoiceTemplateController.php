...
use App\Http\Requests\InvoiceTemplates\InvoiceTemplateRequest;
...
{
    private const TYPE = 'invoice_template';

    private const SLUG = 'invoice-templates';

    private const TITLE = 'Invoice Template';
    ...
    public function update(InvoiceTemplateRequest $request, string $id): JsonResponse
    {
        $record = $this->records->findForModule(self::TYPE, $id);
