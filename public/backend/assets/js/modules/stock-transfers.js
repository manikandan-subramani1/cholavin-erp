(function (window, $) {
    ...
    function openTransferDrawer(row) {
        ...
        var html = '' +
            '<div class="erp-drawer-hero erp-transfer-drawer-hero">' +
                '<div class="erp-drawer-avatar"><i class="ri-arrow-left-right-line"></i></div>' +
            ...
            '</div>' +
            '<div class="erp-drawer-tabs"><button class="active">Overview</button><button>Approval</button><button>Dispatch</button><button>Receipt</button><button>Audit</button></div>' +
            '<ol class="erp-transfer-flow"><li>Draft</li><li>Requested</li><li>Approved</li><li>Dispatched</li><li>Received</li></ol>' +
            '<div class="erp-drawer-actions"><button type="button" class="btn btn-primary" data-transfer-drawer-action="new"><i class="ri-add-line me-1"></i>New Transfer</button><button type="button" class="btn btn-secondary" data-transfer-drawer-action="stock"><i class="ri-stack-line me-1"></i>Stock Overview</button></div>';
    ...
    $(document).on('click', '[data-transfer-drawer-action="new"]', function () { $('#add-transfer').trigger('click'); });
    $(document).on('click', '[data-transfer-drawer-action="stock"]', function () { visitUrl(module.data('stock-url')); });
