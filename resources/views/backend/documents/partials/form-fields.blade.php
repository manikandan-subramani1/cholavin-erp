...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-2"><label class="form-label">Status</label><select id="document-status-input" name="status" class="form-select"><option value="draft">Draft</option><option value="posted">Post now</option></select></div>
...
<div class="table-responsive"><table class="table table-bordered"><thead><tr><th>Product</th><th>Qty (kg / unit)</th><th>Rate</th><th>Discount</th><th>Unit</th><th>Batch</th><th>Expiry</th><th></th></tr></thead><tbody id="document-items"></tbody></table></div>
<div class="alert alert-info py-2 mb-2"><i class="ri-scales-2-line me-1"></i>Sell partial quantities such as 10 kg from a 25 kg bag. Stock and inventory history are recorded in the entered unit.</div><div class="text-end"><strong>Estimated total: &#8377;<span id="document-estimated-total">0.00</span></strong><small class="d-block text-muted">Final tax, allocated expense, and totals are recalculated securely on the server.</small></div>
